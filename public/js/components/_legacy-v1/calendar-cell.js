    ...
    return html`
      <div class="${classes}" @click=${this._handleClick}>
        ...
        <div class="icons">
          ...
          ${this.wakeUps !== null && this.wakeUps !== undefined ? html`<span style="font-weight:700;color:${this.wakeUps <= 1 ? 'var(--success)' : this.wakeUps <= 3 ? 'var(--warning)' : 'var(--danger)'}">Z</span>` : ''}
        </div>
      </div>
    `;
  }
