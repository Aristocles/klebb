...
class ActivityCard extends LitElement {
  ...
  static styles = css`
    ...
    .steps { color: var(--accent); }
    .distance { color: var(--warning); }
    .energy { color: #6366f1; }
    ...
    .bar-fill-steps.empty { background: var(--border); }

    .bar-label { font-size: 10px; color: var(--text-muted); }
    .bar-count { font-size: 9px; color: var(--text-secondary); }
    ...
    .best-day strong { color: var(--accent); }
