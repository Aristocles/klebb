...
class SleepCard extends LitElement {
  ...
  static styles = css`
    ...
    .times { font-size: 13px; color: #aaaacc; margin-bottom: 8px; }
    .stages { font-size: 12px; color: #8888aa; }
    ...
    .bar-fill-sleep.good { background: #44ff88; }
    .bar-fill-sleep.ok { background: #ffaa00; }
    .bar-fill-sleep.bad { background: #ff4444; }
    .bar-fill-sleep.none { background: #2a2a4a; }
    ...
    .week-stat-value.good { color: #44ff88; }
    .week-stat-value.ok { color: #ffaa00; }
    .week-stat-value.bad { color: #ff4444; }
