...
//
// Settings shell. Hosts the HAE panel, hidden-discoveries list, and the
// per-card master enable/disable list (delegated to <eh-settings-cards>).
// The tabbed shell lands in a follow-up commit; this one is the
// extraction step so the file stops being a 1000+ LOC monolith.
